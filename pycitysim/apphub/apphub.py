...
class AppHubClient:
    ...
    def __init__(
        ...
        """
        Args:
        - app_id: app ID，从前端注册页面获取
        - app_secret: app secret，从前端注册页面获取
        """
    ...
    def update_agent_map(
        ...
        Args:
        - agent_id: agent的ID
        - lnglat: 经纬度，格式为 [lng, lat]
        - geojsons: geojson FeatureCollection，用于在地图上显示点线面
        - street_view: 街景图片
        - popup: 弹出框内容
