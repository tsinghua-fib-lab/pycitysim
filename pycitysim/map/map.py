...
class Map:
    ...
    def __init__(
        ...
        - external["tencent_poi_id"] (string): 腾讯地图的POI编号。POI ID in Tencent map.
        """
        ...
        POI collection in the map, the value of the dictionary is the same as self.pois, but the key is the POI ID of Tencent Map
        """
